...
<div class="card card-style">
  ...
  <input type="hidden" id="gender" name="gender" value="">
   ...
   <div style="text-align: center;">
        ...
        <span class="carOptStyle"><input type="radio"  value="4" class="form-check-input" name="carOpt"  checked> <svg style="flex-direction: column;" xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-car-front-fill" viewBox="0 0 16 16">
...
<span class="carOptStyle" style =" margin-right: 9px;"><input type="radio"  value="6" class="form-check-input" name="carOpt" > <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-truck-front-fill" viewBox="0 0 16 16">
...
<span class="carOptStyle"style =" margin-right: 9px;"><input type="radio"  name="carOpt" value="8" style =" margin-right: 9px;" class="form-check-input" name="carOpt" ><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-bus-front-fill" viewBox="0 0 16 16">
...
<span>장애인</span>
  ...
  <input class="form-check-input custom-checkbox" type="checkbox" value="1" id="animalOpt" onclick="updateAnimalOptValue()">
